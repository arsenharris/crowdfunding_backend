...
AWS_STORAGE_BUCKET_NAME = os.environ.get("AWS_STORAGE_BUCKET_NAME", "s3-crowdfunding")
...
# to install pillow , deactivate conda, run venv, and make sure if you use python3.